...
Execute unit tests
```
    cd "AWSLambda.Collection.SendEmailSES/test/AWSLambda.Collection.SendEmailSES.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AWSLambda.Collection.SendEmailSES/src/AWSLambda.Collection.SendEmailSES"
